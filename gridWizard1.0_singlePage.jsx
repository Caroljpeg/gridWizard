...
function gridWizardPalette() {
    ...
    buttonsGroup.alignChildren = ['fill', 'fill'];
        ...
        okButton.onClick = function(){
            ...
            masterSpread = doc.masterSpreads.item(masterIndex).pages.item(0);
            ...
            if(myPalette.subTabs.selection == 0){
                ...
                pureChaos(PCMyAreasRatio, PCMyColumnsNumber, PCMyRowsNumber, PCMyGutterMinWidth, PCMyGutterMaxWidth, PCMyGutterMinHeight, PCMyGutterMaxHeight);
            }
        }
    myPalette.show();
}
...
function IKissedASquareAndILikedIt(areasRatio, shortSideSubdivisions, gutter) {
    ...
    if (pageHeight >= pageWidth) {
        ...
        for (var i = 0; i < longSideSubdivisions; i++) {
            ...
            masterSpread.guides.add(undefined, { orientation: HorizontalOrVertical.vertical, location: yPosition });
            masterSpread.guides.add(undefined, { orientation: HorizontalOrVertical.vertical, location: yPosition + subdivisionsLenght });
        }
        ...
        for (var j = 0; j < shortSideSubdivisions; j++) {
            ...
            masterSpread.guides.add(undefined, { orientation: HorizontalOrVertical.horizontal, location: xPosition });
            masterSpread.guides.add(undefined, { orientation: HorizontalOrVertical.horizontal, location: xPosition + subdivisionsLenght });
        }
    }
